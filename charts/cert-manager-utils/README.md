...
| checkCertManagerCRDs | bool | `false` | Ensure that the necessary CRDs are installed Note: This function generates an error when used with the template command for local testing, and therefore, you can disable it.  |
